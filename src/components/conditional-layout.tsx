...
export function ConditionalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="relative flex-1 overflow-auto pt-16 md:pt-0 pb-20 md:pb-0 px-4 sm:px-6 md:px-10 lg:px-12 py-4 md:py-8 page-enter transition-all duration-300 ease-in-out">
